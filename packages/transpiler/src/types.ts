// https://github.com/Ripple-TS/ripple/blob/main/packages/ripple/src/compiler/types/parse.d.ts
...
export namespace Parse {
  ...
  export declare class Parser extends acorn.Parser {
     ...
     */
    finishNodeAt<T extends AST.Node>(
      node: T,
      type: string,
      pos: number,
      loc: AST.Position,
    ...
    // static parse(input: string, options: Options): AST.Program;
