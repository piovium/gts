...
function gtsToTypings(
  ...
  // The esrap printer is patched (via bun patch) to handle:
  // - node.isDummy: writes empty string for dummy identifiers
  // - node.lParenLoc: uses custom location for opening parenthesis in call/new expressions
